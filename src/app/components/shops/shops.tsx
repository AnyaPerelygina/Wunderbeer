      ...
      <Container className={styles.container}>
        ...
        <div className={styles.images}>
          <div className={styles.image}>
            <picture>
              <source type="image/webp" media="(min-width: 320px)" srcSet={`${basePath}/shops/shops-1.webp`} />
              <Image
                src={`${basePath}//shops/shops-1.png`}
                width={540}
                height={359}
                alt="Изображение пивного магазина."
              />
            </picture>
          </div>
          <div className={styles.image}>
            <picture>
              <source type="image/webp" media="(min-width: 320px)" srcSet={`${basePath}/shops/shops-2.webp`} />
              <Image
                src={`${basePath}//shops/shops-2.png`}
                width={540}
                height={359}
                alt="Изображение пивного магазина."
              />
